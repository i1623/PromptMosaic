...
- **Bilingual tile editing** - view English prompt text and local-language labels side by side while arranging words or sentences as tiles with drag-and-drop, emphasis, and ON/OFF toggles. Frequently used combinations can be saved as tile groups and reused for variation generation with shuffle or random selection.
